...
**Requirements:** R40, R41, R42, R43, R44, R45, R46, R47, R48, R49, R50, R51, R52, R53, R136, R137, R138, R139, R140, R141, R142, R143, R177, R178, R179
...
- **InjectThemeBlock(baseDir)**: Updates index.html with frictionless block (delegates to InjectThemeBlockInFile)
- **InjectThemeBlockInFile(baseDir, filePath)**: Patches any HTML file — replaces content between markers if present, otherwise inserts after `<head>` (R177)
- **InjectAllThemeBlocks(baseDir)**: Scans html/*.html for files with frictionless markers and patches them all (R178)
...
- **WatchIndexHTML(baseDir, log)**: Watches index.html for writes; re-injects theme block if missing. On CSS changes, calls InjectAllThemeBlocks to update all HTML files (R179)
